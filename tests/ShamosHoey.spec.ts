...
test.group("ShamosHoeyTest", () => {
  ...
  test("test non simple hole", ({ expect }) => {
    const polygon = Polygon.create();
  ...
  test("test intersecting hole", ({ expect }) => {
    const polygon = Polygon.create();
  ...
  test("test intersecting holes", ({ expect }) => {
    const polygon = Polygon.create();
  ...
  test("test hole inside hole", ({ expect }) => {
    const polygon = Polygon.create();
  ...
  test("test external hole", ({ expect }) => {
    const polygon = Polygon.create();
  ...
  test("test large non simple", ({ expect }) => {
    const increment = 0.01;
    const radius = 1250;
    let x = -radius + increment;
    let y = 0;
